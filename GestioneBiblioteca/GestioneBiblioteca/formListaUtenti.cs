...
namespace GestioneBiblioteca
{
    public partial class formListaUtenti : Form
    {
        ...
        // FUNZIONE CHE RITORNA INTERAMENTE LA LISTA DEGLI UTENTI //
        ...
        private void formListaUtenti_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                connection.Open();
                // INSERIMENTO DATI NELLA DATAGRIDVIEW //
        ...
        private void btnAnnullaUpdateUser_Click(object sender, EventArgs e)
        {
            txtGestioneUtenteDeleteId.Clear();
            txtGestioneUtenteModificaCognome.Clear();
            txtGestioneUtenteModificaNome.Clear();
            txtGestioneUtenteModificaEmail.Clear();
        }
    }
}
